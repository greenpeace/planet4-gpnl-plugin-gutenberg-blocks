...
class Newsletter extends Base_Block {
	...
	public function __construct() {
		...
		add_action( 'wp_ajax_newsletter_form_process', [ $this, 'newsletter_form_process' ] );
		add_action( 'wp_ajax_nopriv_newsletter_form_process', [ $this, 'newsletter_form_process' ] );
		add_action( 'wp_ajax_request_id', [ $this, 'request_id' ] );
		add_action( 'wp_ajax_nopriv_request_id', [ $this, 'request_id' ] );
	}
	...
	public function newsletter_form_process() {
