...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/src/blocks/Donation/js/donationform.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./assets/src/blocks/Donation/js/donationform.js":
/*!*******************************************************!*\
  !*** ./assets/src/blocks/Donation/js/donationform.js ***!
  \*******************************************************/
...
var donationformVue = {};
var url_vars = {}; // REFACTOR IE11 doesn't support UrlSearchParams, so custom UrlParam function.
...
$(document).ready(function () {
      ...
      switch (key) {
        ...
        case 'marketingcode':
          if (formconfig.suggested_frequency[0] === 'E') {
            var url_tmp = 'marketingcode_oneoff';
            formconfig[url_tmp] = value;
          } else {
            var _url_tmp = 'marketingcode_recurring';
            formconfig[_url_tmp] = value;
          }
  ...
  var _window$validators = window.validators,
      ...
      between = _window$validators.between,
  ...
  Vue.component('step1', {
    ...
    methods: {
      validate: function validate() {
        ...
        if (isValid) {
          ...
          dataLayer.push({
            ...
            'virtualPageviewStep': 'Stap 1',
            //Vul hier de stap in. E.g. Stap 1, Stap 2, Stap 3, Bedankt
      ...
      changePeriodic: function changePeriodic() {
      ...
      toggleCustomamount: function toggleCustomamount() {
  ...
  Vue.component('step3', {
    ...
    methods: {
      ...
      fetchAddress: function fetchAddress() {
        ...
        this.$http.get('https://api.postcodeapi.nu/v2/addresses/?postcode=' + zipcodeValue + '&number=' + houseNoValue + '').then(function (response) {
          var street = response.body._embedded.addresses[0].street;
          var city = response.body._embedded.addresses[0].city.label;
          this.populateFields(street, city);
        }, function () {});
      },
      populateFields: function populateFields(street, city) {
  ...
  donationformVue = new Vue({
    ...
    methods: {
      ...
      onSucces: function onSucces() {
        ...
        $('.wizard-footer-right .wizard-btn').text('Afgerond'); // Push step to tag manager
      ...
      submitiDeal: function submitiDeal() {
        var clangct = getUrlVars()['clangct'];
      ...
      disableFormElements: function disableFormElements(elements) {
      ...
      getGTMTransactionId: function getGTMTransactionId() {
