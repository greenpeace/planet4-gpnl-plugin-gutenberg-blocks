...
/***/ "./assets/src/blocks/Inforequest/js/InforequestHelper.js":
/*!***************************************************************!*\
  !*** ./assets/src/blocks/Inforequest/js/InforequestHelper.js ***!
  \***************************************************************/
...
$(document).ready(function () {
  var auth = new URLSearchParams(window.location.search).has('e');
...
function showErrorMessage(request_form_element) {
  ...
  $(request_form_element).append('<a href=\'' + window.location.href + '\' class="btn btn-primary btn-block"' + '">Probeer je het nog eens? </a>');
...
/******/ });
//# sourceMappingURL=inforequestHelper.js.map